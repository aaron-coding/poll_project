...
ActiveRecord::Schema.define(version: 20141023172441) do
  ...
  add_index "answer_choices", ["question_id", "text"], name: "index_answer_choices_on_question_id_and_text", unique: true
  ...
  add_index "questions", ["poll_id", "text"], name: "index_questions_on_poll_id_and_text", unique: true
